...
const whydata: whydata[] = [
    {
        heading: "Comprehensive AI Analysis",
        subheading: "Analyze facial expressions, tone, pitch, and more..",
    },
    {
        heading: "Real-Time Feedback and Guidance",
        subheading: "AI chatbot guides you through interview questions.",
    },
    {
        heading: "Precision in Performance Improvement",
        subheading: "Review Video Mock Interviews with precise timestamps.",
    },
];
